...
When users click the buy button, they will be able to see the available balance, shares owned, total worth, current price, high, and low. If the total price exceeds available balance, there will be an error message and the button won't be able to be clicked as shown below.
